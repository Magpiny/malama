// /////////////////////////////////////////////////////////////////////////////
// Name:        include/common/constants.hpp
...
const std::string default_ollama_host = "127.0.0.1";
const std::string default_ollama_port = "11434";
...
const std::string fallback_model_name = "ornith:latest";
...
// Malama UI Hex Theme Palette Mappings
const wxString body_text_color = "#f5f5f7";
const wxString headers_text_color = "#c4929a";
const wxString sidebar_bg_color = "#282c34";
const wxString chatpanel_bg_color = "#282c34";
const wxString chatinput_text_color = "#c0caf5";
const wxString chatinput_bg_color = "#1e1e2e";
const wxString appwindow_bg_color = "#1a1b26";
const wxString codeblock_bg_color = "#11111b";
