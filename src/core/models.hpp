...
struct Message {
    ...
    struct glaze {
        ...
        static constexpr auto value = glz::object(
            ...
            "timestamp", &Type::m_timestamp,
            "is_starred", &Type::m_is_starred
        );
    };
};
...
struct SessionMetadata {
    ...
    struct glaze {
        ...
        static constexpr auto value = glz::object(
            "session_id", &Type::m_session_id,
            "title", &Type::m_title,
            "created_at", &Type::m_created_at,
            "updated_at", &Type::m_updated_at,
            "is_pinned", &Type::m_is_pinned
        );
    };
};
